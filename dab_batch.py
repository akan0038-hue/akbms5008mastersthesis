...
fasta_dir = "FASTA"
output_dir = "json_dir/dab"
smiles = "O=C(N[C@H](C(N[C@H](C(N1CCC[C@H]1C(N[C@H](C(N2CCCC[C@H]2C(N[C@H](C(O)=O)c3ccccc3)=O)=O)Cc4ccccc4)=O)=O)CC)=O)CCN)c5ccccc5"
...
for fasta_name, residue_index in mod_mapping.items():
    ...
    cmd = [
        ...
        "--te_modification", "0", str(residue_index), smiles, "dab",
        "--max_iterations", "5000",
        "--num_conformers", "200",
        "--save_ccd",
        "--output", output_path
